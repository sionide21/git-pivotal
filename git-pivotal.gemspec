...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{Jeff Tucker}, %q{Sam Stokes}]
  s.date = %q{2011-05-19}
  s.description = %q{A collection of git utilities to ease integration with Pivotal Tracker}
  s.email = %q{jeff@trydionel.com}
  s.executables = [%q{git-finish}, %q{git-accept}, %q{git-pick}, %q{git-reject}, %q{git-chore}, %q{git-bug}, %q{git-review}, %q{git-info}, %q{git-feature}, %q{git-comment}]
  s.extra_rdoc_files = [
    "LICENSE"
  ]
  s.files = [
